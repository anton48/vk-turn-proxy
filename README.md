...
- YYY.YYY.YYY.YYY: адрес, на котором должен слушать WireGuard сервер (обычно выбирается локальный 127.0.0.1)
  
- 51820: порт, на котором должен слушать WireGuard сервер
